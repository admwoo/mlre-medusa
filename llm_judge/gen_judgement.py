...
if __name__ == "__main__":
    ...
    if ref_answers and args.judge_model not in ref_answers:
        # Use the first available reference model
        first_ref_model = list(ref_answers.keys())[0]
        ref_answers[args.judge_model] = ref_answers[first_ref_model]
    # Load judge
    ...
    if args.mode == "single":
        ...
        output_file = (
            f"data/{args.bench_name}/model_judgment/{args.judge_model}_{models}_single.jsonl"
        )
