    ...
    for _ in range(3):
        ...
        for j in range(len(question["turns"])):
            ...
            try:
                ...
                # Use the baseline generate method to only use backbone model
                output_text = ""
                for step in model.baseline_generate(
                    input_ids,
                    temperature=0.7,
...
if __name__ == "__main__":
    ...
    if args.answer_file:
        ...
        answer_file = f"data/{args.bench_name}/model_answer/{args.model_id}-baseline.jsonl"
